...
function getAddress(tokenA, tokenB) {
    ...
    let address = ethers_1.utils.getCreate2Address({
        ...
        salt: ethers_1.utils.solidityKeccak256(['bytes'], [ethers_1.utils.solidityPack(['address', 'address'], [tokens[0], tokens[1]])]),
...
function getOnChainReserves(PairAddr, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pairContract = new ethers_1.ethers.Contract(PairAddr, uniswapV2PairAbi, provider);
...
function getCostOutputToken(TokenAddr, TokenDecimals, GasPriceWei, SwapGasCost, Provider) {
    return __awaiter(this, void 0, void 0, function* () {
